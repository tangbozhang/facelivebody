#ifndef __HOLIDAY_BATCH_TO_SPACE_ND_GPU_H_
#define __HOLIDAY_BATCH_TO_SPACE_ND_GPU_H_

#include "HolidayBaseLayer.h"
#include "HolidayNetResource.h"
#include "HolidayCommonCuda.h"

class HolidayBatchToSpaceNDGPU : public HolidayBaseLayer<float>
{
public:
    HolidayBatchToSpaceNDGPU();
	~HolidayBatchToSpaceNDGPU();
