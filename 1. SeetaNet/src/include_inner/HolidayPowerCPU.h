#ifndef __HOLIDAY_POWER_CPU_H__
#define __HOLIDAY_POWER_CPU_H__
#include "HolidayBaseLayer.h"
#include <cmath>

template <class	T>
class HolidayPowerCPU : public HolidayBaseLayer<T>
{
public:
	HolidayPowerCPU();
	~HolidayPowerCPU();
...
template <class	T>
HolidayPowerCPU<T>::HolidayPowerCPU()
{
...
template <class	T>
int HolidayPowerCPU<T>::Init(Holiday_LayerParameter& inputparam, HolidayNetResource<T> *pNetResource)
{
	m_scale = inputparam.power_param().scale();
	m_shift = inputparam.power_param().shift();
	m_power = inputparam.power_param().power();
...
template <class	T>
int HolidayPowerCPU<T>::Process(std::vector<HolidayFeatureMap<T>*> input_data_map, std::vector<HolidayFeatureMap<T>*>& output_data_map)
{
