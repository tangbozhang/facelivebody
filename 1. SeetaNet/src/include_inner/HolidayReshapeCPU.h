#ifndef __HOLIDAY_RESHAPE_H_
#define __HOLIDAY_RESHAPE_H_

#include "HolidayBaseLayer.h"

template <class	T>
class HolidayReshapeCPU : public HolidayBaseLayer<T>
{
public:
    HolidayReshapeCPU();
    ~HolidayReshapeCPU();
...
template <class	T>
HolidayReshapeCPU<T>::HolidayReshapeCPU()
{
...
template <class	T>
int HolidayReshapeCPU<T>::Init(Holiday_LayerParameter& inputparam, HolidayNetResource<T> *pNetResource)
{
...
template <class	T>
int HolidayReshapeCPU<T>::Process(std::vector<HolidayFeatureMap<T>*> input_data_map, std::vector<HolidayFeatureMap<T>*>& output_data_map)
{
