#ifndef __HOLIDAY_SPACE_TO_BATCH_ND_H_
#define __HOLIDAY_SPACE_TO_BATCH_ND_H_
...
template <class	T>
class HolidaySpaceToBatchNDCPU : public HolidayBaseLayer<T>
{
public:
    HolidaySpaceToBatchNDCPU();
	~HolidaySpaceToBatchNDCPU();
...
template <class	T>
HolidaySpaceToBatchNDCPU<T>::HolidaySpaceToBatchNDCPU()
{
...
template <class	T>
void HolidaySpaceToBatchNDCPU<T>::CaculateOutputSize(int input_number, int input_height, int input_width, int input_channels,
                        int &output_number, int &output_height, int &output_width, int &output_channels)
{
...
template <class	T>
int HolidaySpaceToBatchNDCPU<T>::Init(Holiday_LayerParameter& inputparam, HolidayNetResource<T> *pNetResource)
{
	// set bottom size
...
template <class	T>
int HolidaySpaceToBatchNDCPU<T>::Process(std::vector<HolidayFeatureMap<T>*> input_data_map, std::vector<HolidayFeatureMap<T>*>& output_data_map)
{
	// trans param to cpu
