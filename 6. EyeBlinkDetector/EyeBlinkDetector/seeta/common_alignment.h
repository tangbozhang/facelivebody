 ...
 * \param crop_width 输出宽度，对于标准人脸最后获取的宽度，\b 并不绝对是输出图像的宽度，受 pad 参数影响
 * \param crop_height 输出高度，对于标准人脸最后获取的高度，\b 并不绝对是输出图像的高度，受 pad 参数影响
 * \param points 定位的特征点，以 {x1, y1, x2, y2, ...} 的格式存放
 * \param points_num 特征点数量
 * \param mean_shape 平均人脸模型，以 {x1, y1, x2, y2, ...} 的格式存放
