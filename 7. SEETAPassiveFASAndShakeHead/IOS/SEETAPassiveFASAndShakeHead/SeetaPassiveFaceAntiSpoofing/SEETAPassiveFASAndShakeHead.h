...
enum SystemState
{
    noFace, detecting, pleaseTrun, passed, notPass, pleaseBlink,pleaseNodHead, pleaseFaceTheCamera,
    verifying /* verify after anti-spoofing */, 
...
public:
    ...
    VIPL_API void setVerifyingThreshold(float threshold = 0.7);
private:
