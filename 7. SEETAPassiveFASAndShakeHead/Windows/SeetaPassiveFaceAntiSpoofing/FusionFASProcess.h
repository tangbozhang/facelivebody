...
public:
    ...
    void updateSnapshot(const VIPLImageData &image, const VIPLFaceInfo& face, float score);
	void updateSnapshot(const VIPLImageData& image, const VIPLFaceInfo& info, const  float &yawAngle, const  float &pitchAngle, const  float & rollAngle, const double &clarity);
